...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { assistance: @concert.assistance, band_id: @concert.band_id, location: @concert.location, name: @concert.name } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { assistance: @concert.assistance, band_id: @concert.band_id, location: @concert.location, name: @concert.name } }
