...
class CrewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crew" do
    assert_difference('Crew.count') do
      post crews_url, params: { crew: { band_id: @crew.band_id, name: @crew.name, sex: @crew.sex } }
    end
  ...
  test "should update crew" do
    patch crew_url(@crew), params: { crew: { band_id: @crew.band_id, name: @crew.name, sex: @crew.sex } }
